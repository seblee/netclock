/**
  @page " Changed from hello_world"  demo
...
This demo shows:  
    ...
    - MICO_SYS_LED is mapping to a GPIO, which can refer to platform.c and paltform.h.
 

@par Directory contents 
    - Demos/helloworld/hello_world.c   Applicaiton program
    - Demos/helloworld/mico_config.h   MiCO function header file
